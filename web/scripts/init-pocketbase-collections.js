  ...
  const collections = [
    ...
    },
    {
      ...
      schema: [
        ...
        { name: 'asset_description', type: 'text', required: false, options: {} },
        { name: 'asset_unit', type: 'relation', required: false, options: { collectionId: '_pb_users_auth_', maxSelect: 1, cascadeDelete: false } },
        { name: 'occurred_at', type: 'date', required: false, options: {} },
      ],
      listRule: '@request.auth.id != ""',
      viewRule: '@request.auth.id != ""',
